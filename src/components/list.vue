<template>
  <div>
    <v-app-bar fixed dense background-color="white" hide-on-scroll extension-height="55">
      <!-- <v-btn icon>
        <v-icon>mdi-arrow-left</v-icon>
      </v-btn> -->
      <v-toolbar-title
        class="subtitle-1 ml-0   font-weight-regular"
      >What would you like to eat?</v-toolbar-title>
      ...
      <template v-slot:extension>
        <v-tabs       center-active  :show-arrows="false" color="orange" icons-and-text height="55" background-color="transparent">
          <v-tab  class="caption font-weight-medium text-capitalize" v-for="n in 20" :key="n">
            chuks{{n}}
            <v-avatar size="25" tile color="white" style="border-radius:4px" class="elevation-10">
              <img src="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt />
            </v-avatar>
          </v-tab>
        </v-tabs>
      </template>
    </v-app-bar>
    <v-flex xs12 lg9 class style="margin: 6rem 0px 2rem 0px">
      <v-card style="overflow-x:hidden;" flat tile color="transparent">
        <v-card-title class="body-1 font-weight-bold grey--text ">Popular Food <div class="flex-grow-1"></div><v-btn icon><v-icon>mdi-format-list-bulleted-square</v-icon></v-btn>
